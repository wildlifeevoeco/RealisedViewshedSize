...
```{r how numeric variables (shrub, cover, temperature, velocity) influence ECA size (continued)}
# Cover
#parallel and perpendicular distances
runs <- seq(from = -10, to = 10, by = 1)
...
```{r how numeric variables (shrub, cover, temperature, velocity) influence ECA size (continued 2)}
# Temp
#parallel and perpendicular distances
runs <- seq(from = -10, to = 10, by = 1)
...
```{r how numeric variables (shrub, cover, temperature, velocity) influence ECA size (continued 3)}
#velocity 
#parallel and perpendicular distances
runs <- seq(from = -10, to = 10, by = 1)
