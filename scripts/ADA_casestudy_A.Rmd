---
title: "Calculating the Realised Viewshed Area for Case Study A"
---
...
#saving GAMM model for RVS calculations later.
...
shrub_es$prediction <- predict_gamm(total_mod$gam, shrub_es, type = "link", 
                          se.fit = TRUE, re_form =  NA, 
...
cover_es$prediction <- predict_gamm(total_mod$gam, cover_es, type = "link", 
                          se.fit = TRUE, re_form =  NA, 
...
temp_es$prediction <- predict_gamm(total_mod$gam, temp_es, type = "link", 
                          se.fit = TRUE, re_form =  NA, 
                          exclude = c("seconds_since"))
...
velocity_es$prediction <- predict_gamm(total_mod$gam, velocity_es, type = "link", 
                          se.fit = TRUE, re_form =  NA, 
                          exclude = c("seconds_since"))
