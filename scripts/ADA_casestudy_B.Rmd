---
title: "Calculating the Realised Viewshed Size for Case Study B"
...
```{r, Generating RVS through prediciton}
...
```{r,calculating RVS for combos of sensitivity + # photos and plotting}
#Figure 4. RVS's  based on all combinations of sensitivity and #of photos per trigger
## held at day time. I just calculated RVS above, and imported values below. 
...
```{r, Daytime and nighttime figures (Figure 5) RVS code}
